/*
 * w1_ds2413.c - w1 family 85 (DS2413) driver
 * based on w1_ds2408.c by Jean-Francois Dagenais <dagenaisj@sonatest.com>
 * based on w1_ds2408.c by (c) 2013 Mariusz Bialonczyk <manio@skyboo.net>
 *
 * Copyright (c) 2019 Patric Lintschinger <patric.lintschinger@gmail.com>
 *
...
module_w1_family(w1_family_85);

MODULE_AUTHOR("Mariusz Bialonczyk <manio@skyboo.net>");
MODULE_DESCRIPTION("w1 family 85 driver for DS2413 2 Pin IO");
MODULE_LICENSE("GPL");
